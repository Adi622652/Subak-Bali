...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - Subak Bali Admin</title>
    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-green-dark text-white flex flex-col fixed h-full z-20">
            ...
            <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-green-medium text-green-pale shadow-inner' : 'text-white hover:bg-green-medium hover:pl-5'); ?>">
                    <i class="fa-solid fa-gauge-high w-5 text-center"></i>
                    <span>Dashboard</span>
                </a>
                
                <a href="<?php echo e(route('admin.subak.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all <?php echo e(request()->routeIs('admin.subak.*') ? 'bg-green-medium text-green-pale shadow-inner' : 'text-white hover:bg-green-medium hover:pl-5'); ?>">
                    <i class="fa-solid fa-database w-5 text-center"></i>
                    <span>Data Subak</span>
                </a>
                
                <?php if(auth()->user()->isSuperAdmin()): ?>
                <a href="<?php echo e(route('admin.pengguna.index')); ?>" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all <?php echo e(request()->routeIs('admin.pengguna.*') ? 'bg-green-medium text-green-pale shadow-inner' : 'text-white hover:bg-green-medium hover:pl-5'); ?>">
            ...
            <div class="p-4 border-t border-green-medium">
                <div class="flex items-center space-x-3 mb-6 px-2">
                    ...
                    <div class="overflow-hidden">
                        <p class="text-sm font-bold truncate"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-[10px] uppercase text-green-pale font-bold tracking-widest"><?php echo e(auth()->user()->role); ?></p>
                    </div>
                </div>
...
<?php /**PATH C:\Users\user\Downloads\Kimi_Agent_Subak Bali 网站开发\subak-bali\resources\views/layouts/admin.blade.php ENDPATH**/ ?>