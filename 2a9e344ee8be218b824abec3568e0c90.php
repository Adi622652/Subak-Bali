...
<section class="relative h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('subak.index')); ?>" class="bg-green-pale text-green-dark px-8 py-3 rounded-full font-bold hover:bg-white transition-colors">
                Jelajahi Data Subak
            </a>
            <a href="<?php echo e(route('about')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-green-dark transition-colors">
                Tentang Subak
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <a href="<?php echo e(route('about')); ?>" class="inline-flex items-center bg-green-medium text-white px-8 py-3 rounded-full font-semibold hover:bg-green-dark transition-all shadow-md hover:shadow-lg">
            ...
            <!-- Image -->
            <div class="relative">
                <img src="https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=800" alt="Sawah Terasering Bali" class="rounded-2xl shadow-lg w-full aspect-[4/3] object-cover">
...
<section class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-12">
            ...
            <a href="<?php echo e(route('subak.index')); ?>" class="mt-4 md:mt-0 inline-flex items-center text-green-medium font-bold hover:text-green-dark transition-all group">
                Lihat Semua
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php $__currentLoopData = $latestSubaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl overflow-hidden shadow-md card-hover group">
                ...
                <div class="h-48 bg-gradient-to-br from-green-medium to-green-light relative overflow-hidden">
                    <?php if($subak->foto_url): ?>
                        <img src="<?php echo e($subak->foto_url); ?>" alt="<?php echo e($subak->nama); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300">
                    <?php else: ?>
                ...
                <!-- Content -->
                <div class="p-5">
                    <span class="inline-block bg-green-bg text-green-medium text-xs font-medium px-3 py-1 rounded-full mb-2"><?php echo e($subak->kabupaten); ?></span>
                    <h3 class="text-lg font-bold text-green-dark mb-1"><?php echo e($subak->nama); ?></h3>
                    <p class="text-gray-500 text-sm mb-3"><?php echo e($subak->kecamatan); ?></p>
                    
                    <div class="flex items-center text-sm text-gray-600 mb-2">
                        <i class="fa-solid fa-maximize w-5 text-green-medium"></i>
                        <span><?php echo e($subak->luas_subak); ?></span>
                    </div>
                    
                    <div class="flex items-center text-sm text-gray-600 mb-5">
                        <i class="fa-solid fa-users w-5 text-green-medium"></i>
                        <span><?php echo e($subak->jumlah_anggota); ?> Anggota</span>
                    </div>
                    
                    <a href="<?php echo e(route('subak.show', $subak->slug)); ?>" class="block w-full bg-green-medium text-white text-center py-2 rounded-lg font-medium hover:bg-green-dark transition-colors">
                        Lihat Detail &rarr;
                    </a>
                </div>
            </div>
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('subak.index')); ?>" class="inline-flex items-center bg-green-medium text-white px-10 py-4 rounded-full font-bold hover:bg-green-dark transition-all shadow-lg hover:shadow-xl group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Downloads\Kimi_Agent_Subak Bali 网站开发\subak-bali\resources\views/pages/home.blade.php ENDPATH**/ ?>