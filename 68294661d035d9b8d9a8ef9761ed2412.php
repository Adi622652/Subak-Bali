    ...
    <div class="relative z-10 w-full max-w-md px-4">
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-white/20">
            ...
            <form action="<?php echo e(route('admin.login.post')); ?>" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" required value="<?php echo e(old('email')); ?>" class="w-full border border-gray-200 rounded-xl px-11 py-3.5 focus:outline-none focus:border-green-medium focus:ring-4 focus:ring-green-medium/10 transition-all text-sm" placeholder="admin@subakbali.com">
                    </div>
                </div>
            ...
            <div class="mt-8 text-center pt-6 border-t border-gray-100">
                <a href="<?php echo e(route('home')); ?>" class="text-gray-500 hover:text-green-medium text-sm font-medium transition-colors">
...
<?php /**PATH C:\Users\user\Downloads\Kimi_Agent_Subak Bali 网站开发\subak-bali\resources\views/admin/login.blade.php ENDPATH**/ ?>