...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Platform digital untuk mendata dan menyajikan informasi sistem irigasi tradisional Subak di Bali, Warisan Budaya UNESCO sejak 2012.'); ?>">
    <meta name="keywords" content="Subak, Bali, Irigasi, UNESCO, Warisan Budaya, Pertanian, Padi">
    <meta name="author" content="Subak Bali">
    
    <title><?php echo $__env->yieldContent('title', 'Subak Bali'); ?> - Platform Digital Pelestarian Subak</title>
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 navbar-transparent transition-all duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-green-pale transition-colors <?php echo e(request()->routeIs('home') ? 'text-green-pale font-semibold' : ''); ?>">Beranda</a>
                    <a href="<?php echo e(route('about')); ?>" class="text-white hover:text-green-pale transition-colors <?php echo e(request()->routeIs('about') ? 'text-green-pale font-semibold' : ''); ?>">Tentang</a>
                    <a href="<?php echo e(route('subak.index')); ?>" class="text-white hover:text-green-pale transition-colors <?php echo e(request()->routeIs('subak.*') ? 'text-green-pale font-semibold' : ''); ?>">Data Subak</a>
                    <a href="<?php echo e(route('contact')); ?>" class="text-white hover:text-green-pale transition-colors <?php echo e(request()->routeIs('contact') ? 'text-green-pale font-semibold' : ''); ?>">Kontak</a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-green-dark shadow-2xl">
            <div class="px-4 py-6 space-y-4">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-3 text-white hover:text-green-pale py-2 <?php echo e(request()->routeIs('home') ? 'text-green-pale font-semibold' : ''); ?>">
                    <i class="fa-solid fa-house w-6"></i>
                    <span>Beranda</span>
                </a>
                <a href="<?php echo e(route('about')); ?>" class="flex items-center space-x-3 text-white hover:text-green-pale py-2 <?php echo e(request()->routeIs('about') ? 'text-green-pale font-semibold' : ''); ?>">
                    <i class="fa-solid fa-info-circle w-6"></i>
                    <span>Tentang</span>
                </a>
                <a href="<?php echo e(route('subak.index')); ?>" class="flex items-center space-x-3 text-white hover:text-green-pale py-2 <?php echo e(request()->routeIs('subak.*') ? 'text-green-pale font-semibold' : ''); ?>">
                    <i class="fa-solid fa-database w-6"></i>
                    <span>Data Subak</span>
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="flex items-center space-x-3 text-white hover:text-green-pale py-2 <?php echo e(request()->routeIs('contact') ? 'text-green-pale font-semibold' : ''); ?>">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="<?php echo e(route('home')); ?>" class="group flex items-center text-gray-300 hover:text-green-pale transition-colors text-sm">
                            <i class="fa-solid fa-chevron-right text-[10px] mr-2 group-hover:translate-x-1 transition-transform"></i>
                            Beranda
                        </a></li>
                        <li><a href="<?php echo e(route('about')); ?>" class="group flex items-center text-gray-300 hover:text-green-pale transition-colors text-sm">
                            <i class="fa-solid fa-chevron-right text-[10px] mr-2 group-hover:translate-x-1 transition-transform"></i>
                            Tentang Subak
                        </a></li>
                        <li><a href="<?php echo e(route('subak.index')); ?>" class="group flex items-center text-gray-300 hover:text-green-pale transition-colors text-sm">
                            <i class="fa-solid fa-chevron-right text-[10px] mr-2 group-hover:translate-x-1 transition-transform"></i>
                            Data Subak
                        </a></li>
                        <li><a href="<?php echo e(route('contact')); ?>" class="group flex items-center text-gray-300 hover:text-green-pale transition-colors text-sm">
                            <i class="fa-solid fa-chevron-right text-[10px] mr-2 group-hover:translate-x-1 transition-transform"></i>
                            Kontak
                        </a></li>
                    </ul>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-white font-medium">08775903532</p>
                            </div>
                        </li>
                        <li class="flex items-start space-x-4">
                            <div class="w-8 h-8 rounded-md flex items-center justify-center text-green-pale shrink-0 mt-0.5">
...
<?php /**PATH C:\Users\user\Downloads\Kimi_Agent_Subak Bali 网站开发\subak-bali\resources\views/layouts/app.blade.php ENDPATH**/ ?>